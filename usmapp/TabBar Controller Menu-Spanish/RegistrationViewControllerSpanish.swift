...
class RegistrationViewControllerSpanish: UIViewController, UIWebViewDelegate {
    ...
    override func viewDidLoad() {
        ...
        let url = URLRequest(url: URL(string: "https://fs2.formsite.com/universitykingjesusministryorg/form3/")!)
